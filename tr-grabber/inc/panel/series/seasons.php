    ...
    if (isset($ses)) {
        ...
        foreach (array_slice($data, $page * $nb_elem_per_page, $nb_elem_per_page) as $p) {
            ...
            if (TR_GRABBER_UPLOAD_IMAGES == 1 and isset($p['poster_path']) and isset($array_seasons) and !in_array($p['season_number'], $array_seasons)) {
                ...
                if (is_rtl()) {
                    $title_img = md5(sanitize_title($ainpb));
                } else {
                    $title_img = sanitize_title($ainpb);
                }
            ...
            if ($p['season_number'] == 0) {
                update_term_meta($cid, 'season_special', 1);
            }
